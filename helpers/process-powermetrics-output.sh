...
# this script.
#
# The CheckThermals function needs iStatistica (https://www.imagetasks.com/istatistica/)
# running on the Mac in question with enabled Web mode and API accessible on default 
# port 4027
# 
#
# Prerequisits:
